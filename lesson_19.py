...
if __name__ == '__main__':
 ...
 with open('file.json', 'r') as f:
     temp_2 = json.load(f)
   #  login_error =temp_2["save_last_wrong_time_login"]
     saving_login_error = datetime.datetime.strptime(temp_2["save_last_wrong_time_login"],'%d-%m-%Y %H:%M:%S')
 ...
 while func_time(saving_login_error) == True:
     ...
     while count != 0:
         ...
         with open('file.json', 'r') as f:
             temp_2 = json.load(f)
             temp_2.update({'save_last_wrong_time_login': saving_login_error})
         with open('file.json', 'w') as f:
             json.dump(temp_2, f, indent=4)
